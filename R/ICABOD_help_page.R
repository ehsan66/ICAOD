...
#'
#' @description Different functions are available to find optimal designs for nonlinear models using the imperialist competitive algorithm (ICA).
#' Because the optimality criteria for nonlinear models depend on the unknown parameters,
