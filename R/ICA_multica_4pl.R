...
#
#      The user can easily transform \eqn{a}, \eqn{b}, \eqn{c}, \eqn{d} and \eqn{D}
#    to \eqn{\theta_1}{\theta1}, \eqn{\theta_2}{\theta2}, \eqn{\theta_3}{\theta3}, \eqn{\theta_4}{\theta4}
#     and \eqn{x} to find the multiple-objective optimal design for the 4-parameter logistic model with this function and then
...
#' @param param a vector of parameters  \eqn{\bold{\theta} = (\theta_1, \theta_2, \theta_3, \theta_4)}{\theta = (\theta1, \theta2, \theta3, \theta4)}.
#' @param iter maximum number of iterations.
#' @param k number of design (support) points. Must be larger than the number of \eqn{4} to avoid the singularity of the FIM.
#' @param lambda the relative importance of each of the 3 criteria,
