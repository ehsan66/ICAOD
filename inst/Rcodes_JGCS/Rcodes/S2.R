...
res_gam[[1]]$crt_bayes_control = list(method <- "cubature",
                                      cubature = list(maxEval = 50000))
res_gam[[1]]$prior <- uni1


res_gam[[2]]$crt_bayes_control = list(method <- "quadrature",
                                      quadrature = list(level = 3))
res_gam[[2]]$prior <- uni1

res_gam[[3]]$crt_bayes_control = list(method <- "cubature",
                                      cubature = list(maxEval = 2000))
res_gam[[3]]$prior <- norm1

res_gam[[4]]$crt_bayes_control = list(method <- "quadrature",
                                      quadrature = list(level = 3))
